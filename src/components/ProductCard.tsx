...
export default function ProductCard({ product, index = 0 }: ProductCardProps) {
  ...
  return (
    <div
      className="group relative bg-[#020510] rounded-2xl overflow-hidden border border-white/5 card-hover"
      style={{
    ...
    >
      ...
      <div className="p-4">
        ...
        {/* Title */}
        <h3 className="text-white font-semibold text-sm mb-1 line-clamp-1 group-hover:text-[#3B82F6] transition-colors">
          {product.name}
        </h3>
